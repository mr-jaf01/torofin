            ...
            <section class="flex flex-col justify-center items-center">
                ...
                <div class="flex flex-col justify-center items-center w-full px-5">
                    ...
                    <div class="flex flex-col gap-4 w-full mt-4">
                        ...
                        <a href="{{ route('app.transaction.receipt') }}" class="bg-primarycolor-100 text-white px-4 py-1 rounded-full flex flex-row justify-center items-center w-full">Share Receipt</a>
                    </div>
